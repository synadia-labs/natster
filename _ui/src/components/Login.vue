      ...
      <div class="container relative mx-auto mx-center py-32 sm:py-48 lg:py-56">
        <div class="mx-full w-3/6 items-center content-center">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300">
            ...
            <code class="text-green-500 bg-gray-800">natster login</code> from
            the command line. This will provide you with a link/code you can
            enter below.
          </p>
        </div>
        <div class="mt-10 2xl:h-48 xl:h-20 w-auto gap-x-6">
          <div class="flex flex-col-6 lg:h-full gap-5">
            ...
            >
              <input
                ...
                name="code2"
                id="code2"
                class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 text-center"
                required
              />
            </div>
            <div
            ...
            >
              <input
                ...
                name="code3"
                id="code3"
                class="block text-7xl flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 text-center"
                required
              />
            </div>
            <span class="text-white text-7xl items-center">-</span>
            <div
              class="flex-1 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md bg-gray-50 bg-opacity-50"
            >
              <input
