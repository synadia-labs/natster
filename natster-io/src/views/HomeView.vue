    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
        ...
        <div v-if="!codeProvided" class="mt-10 flex items-center gap-x-6">
          ...
          <router-link to="/getting-started" class="text-sm font-semibold leading-6 text-white">Getting started <span
      ...
      <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none">
        <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
          <img :src="natsterScreen" alt="App screenshot" width="2432" height="1442" class="w-[76rem] rounded-md" />
        </div>
      </div>
    </div>
  </div>
